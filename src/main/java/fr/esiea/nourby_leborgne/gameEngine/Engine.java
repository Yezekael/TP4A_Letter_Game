...
public class Engine {
	...
	public void del(String s, Player p){//fonction qui supprime le mot d'un joueur
		p.delWord(s);
	}
	
	public void add(String s, Player p){//fonction qui ajoute un mot à un joueur
		p.addWord(s);
	...
	public void checkEnd(){//vérifie si un joueur satisfait les conditions de fin
		for(int i=0; i<this.nbPlayer ; i++){
			System.out.println(this.playerList.get(i).getName()+" a "+this.playerList.get(i).getListSize()+" mots.");
	...
	public String drawLetter(Player p){//fonction qui tire une lettre par joueur
